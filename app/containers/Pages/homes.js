...
function Homes(props) {
  const columns = [
    ...
    { title: 'Builder', field: 'builderName' },
    { title: 'Project', field: 'projectName' },
    { title: 'Plan', field: 'planName' },    
    { title: 'Status', field: 'statusCode' },
    { title: 'Bedrooms', field: 'bedrooms' },
    { title: 'Baths', field: 'fullBaths' },
    { title: 'Sq Ft', field: 'areaSqFt' },
    { title: 'Est. Cost', field: 'estimatedCost' },
    { title: 'Contract Date', field: 'dateOfContract' },
    { title: 'Est. Completion', field: 'estimatedCompletion' },
  ];
